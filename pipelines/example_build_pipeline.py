...
from code.util.attach_compute import get_compute
from code.util.env_variables import Env
from code.util.manage_environment import get_environment
import os
...
def main():
    ...
    published_pipeline = pipeline1.publish(
